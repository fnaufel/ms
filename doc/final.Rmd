...
previsoes %>% 
  ggplot(aes(x = est_arrec)) +
    ...
    labs(
      title = 'Nosso modelo para a arrecadação (azul)',
...
previsoes %>% 
  ggplot(aes(x = est_arrec)) +
    ...
    labs(
      title = 'Nosso modelo para ganhadores da quina',
...
previsoes %>% 
  ggplot(aes(x = est_arrec)) +
    ...
    labs(
      title = 'Nosso modelo para ganhadores da quadra',
      subtitle = 'com base nas estimativas da CEF',
      x = 'Estimativa da CEF',
      y = 'Ganhadores'
    ) +
...
Modelos dos rateios em função da arrecadação estimada (mesmo depois de corrigida pelo nosso modelo) têm incerteza grande demais.
